...
router.get('/noleidas/:id_usuario', async (req: Request, res: Response) => {
...
router.put('/leida', async (req: Request, res: Response) => {
    try {
...
router.put('/leidastodas', async (req: Request, res: Response) => {
    try {
